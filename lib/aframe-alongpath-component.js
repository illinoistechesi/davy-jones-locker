...
/***/ (function(module, exports) {
	...
	AFRAME.registerComponent('alongpath', {
	    ...
	    schema: {
	        ...
	        constraint: {default: { x: 0, y: 0, z: 1 }},
	        ...
	        if (curve) {
	            ...
	            if (!this.el.is("endofpath")) {
	                ...
	                if (this.data.rotate === true) {
	                	...
	                	var forward = this.data.constraint.split(" ").map((x) => parseInt(x));
	                	// console.log(this.data.constraint.split(" ").map((x) => parseInt(x)));
	                    var axis = new THREE.Vector3();
	                    var up = new THREE.Vector3(forward[0], forward[1], forward[2]);
